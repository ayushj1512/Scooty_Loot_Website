export default defineEventHandler(async () => {
  const res = await fetch(`https://api.streetstylestore.com/collections/products/documents/search?q=*&filter_by=categories:=893&sort_by=date_updated_unix:desc&per_page=50&page=1&x-typesense-api-key=Bm23NaocNyDb2qWiT9Mpn4qXdSmq7bqdoLzY6espTB3MC6Rx`)
