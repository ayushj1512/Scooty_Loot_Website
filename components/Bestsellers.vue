  ...
  <section class="py-12 bg-gradient-to-b from-gray-50 to-white">
    <div class="max-w-7xl mx-auto px-4">
      <div class="flex justify-between items-center mb-8 flex-wrap gap-2">
        ...
        <NuxtLink
          to="/dishes"
          class="text-red-500 hover:text-red-600 font-semibold text-sm sm:text-base underline"
        >
          View All →
        </NuxtLink>
      </div>

      <div v-if="loadingBS" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        <div
          v-for="i in perPage"
          :key="i"
          class="bg-gray-100 animate-pulse h-64 rounded-xl shadow p-4"
        >
      ...
      <div v-else class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        >
          <img
            ...
            alt=""
            loading="lazy"
            class="w-full h-48 object-cover object-center transition duration-300 group-hover:scale-105"
